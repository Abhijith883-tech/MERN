...
//                     <h2 className="text-center mb-4">Women Product</h2>
//                     <Form>
...
const AdminWomenAdd = () => {
    ...
    const [inputMen, setMen] = useState({
        name: "", gender: "Women", brand: "", price: "", mainImage: "",
        ...
        try {
            if (id) {
                ...
                if (result.status === 201) {
                    ...
                    setMen({ name: "", gender: "Women", brand: "", price: "", mainImage: "", Image1: "", Image2: "", Image3: "", Image4: "", stock: "", typeDress: "" });
                    navigate('/admin/women');
                }
            }
        } catch (error) {
    ...
    return (
        <>
            <Container className="d-flex justify-content-center align-items-center vh-100">
                <Card style={{ width: '36rem', background: 'rgba(98, 255, 0, 0.9)' }} className="bg-white text-dark p-3 rounded shadow">
                    <h2 className="text-center mb-4">{id ? "Edit Women Product" : "Add Women Product"}</h2>
